                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="">
                                <a href="edit-product.php?product_id=<?= $product['id'] ?>" class="btn btn-warning btn-sm" title="Edit Product"><i class="fa-solid fa-pen"></i>
                                </a>
                                <a href="delete-product.php?product_id=<?= $product['id'] ?>" class="btn btn-danger btn-sm" title="Delete Product"><i class="fa-solid fa-trash"></i>
                                </a>
                            </td>
                        <?php
                        ...
                        ?>
                        <td>
                            <a href="../views/buy-product.php?product_id=<?= $product['id'] ?>" class="btn btn-success btn-sm" title="Buy Product"><i class="fa-solid fa-cash-register"></i>
                            </a>
                        </td>
                        <?php
                            }else{
