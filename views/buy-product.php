...
<body>
    ...
    <div class="card w-50 mx-auto border-0">
        ...
        <form action="../views/pay-product.php?product_id=<?= $product_id ?>" method="post" class="w-75 mx-auto pt-4 p-5">
            <div class="row mb-3">
                <div class="col-md">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <p class="h1">$ <?= $product_details['price'] ?></p>
                </div>
                <div class="col-md-6">
                    <label for="quantity" class="form-label small text-secondary">Stock left</label>
                    <p class="h1"><?= $product_details['quantity'] ?></p>
                </div>
            </div>
            <label for="buy_quantity" class="form-label small text-secondary">Buy Quantity</label>
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <input type="number" name="buy_quantity" id="buy_quantity" class="form-control form-control-lg text-center" max="<?= $product_details['quantity'] ?>">
                </div>
            </div>
